    ...
    <Link to={p.to} className="prj-card" style={{ display: 'block', textDecoration: 'none' }}>
      <div style={{ position: 'relative', aspectRatio: '4/3', overflow: 'hidden', borderRadius: 5 }}>
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: 'clamp(24px, 3vw, 40px)', pointerEvents: 'none' }}>
          <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 11, letterSpacing: '0.2em', color: TEAL, textTransform: 'uppercase' }}>{p.year} — {p.location}</span>
          <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 'clamp(24px, 3vw, 38px)', fontWeight: 400, color: 'var(--text)', margin: '8px 0 4px' }}>{p.name}</h3>
