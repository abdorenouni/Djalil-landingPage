...
/** A real-estate project (ASTERIA, MAGNOLIA, …). The client adds/edits these. */
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'featured', title: 'Projet phare (mis en avant)', type: 'boolean', initialValue: false }),
